...
namespace MoviesMaxAPI.DTOs
{
     ...
     * and since we are using FROMFORM in Post & Put actions, we will need to help the model binders to bind the lists that will
     * be posted as payload. For this we will create and use a custom model binder HELPERS/TypeBinder.cs**/
